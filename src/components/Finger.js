...
const Finger = () => {
    ...
    return (
        <div>
            ...
            <img src={require("../assets/dip-highlight.png")} alt="abs" onClick={() => allhighlight("dip")} style={(position === "others" || position === "dip")   ?  showstyle : hidestyle} />
            <img src={require("../assets/dip-active.png")} alt="abs" style={position === "dip" ?  showstyle : hidestyle} />
            ...
            <img src={require("../assets/pip-highlight.png")} alt="abs" onClick={() => allhighlight("pip")} style={(position === "others" || position === "pip")   ?  showstyle : hidestyle} />
            <img src={require("../assets/pip-active.png")} alt="abs" style={position === "pip" ?  showstyle : hidestyle} />
            ...
            <img src={require("../assets/mcp-highlight.png")} alt="abs" onClick={() => allhighlight("mcp")} style={(position === "others" || position === "mcp")   ?  showstyle : hidestyle} />
            <img src={require("../assets/mcp-active.png")} alt="abs" style={position === "mcp" ?  showstyle : hidestyle} />
            ...
            <img src={require("../assets/others-highlight.png")} alt="abs"  style={position === "others" ?  showstyle : hidestyle} />
